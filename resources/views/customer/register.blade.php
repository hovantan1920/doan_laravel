            ...
            <div class="col-lg-6">
                <div class="login_box_img">
                    <div class="hover">
                        ...
                        <a class="button button-account" href="{{route('cus-login')}}">Login Now</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="login_form_inner register_form_inner">
                    ...
                    <form class="row login_form" method="POST" action="{{route('cus-handle.store')}}" id="register_form" >
                        ...
                        <div class="col-md-12 form-group">
                            <input name="username" type="text" class="form-control" id="name" name="name" placeholder="Username" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'">
                        </div>
                        <div class="col-md-12 form-group">
                            <input name="email" type="text" class="form-control" id="email" name="email" placeholder="Email Address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email Address'">
                        </div>
                        <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-12 form-group">
                            <div class="creat_account">
                                <input name="selector-remember" type="checkbox" id="f-option2">
